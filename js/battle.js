...
// r: moveInfo.rank
// self: 사용자, target: 상대
// chance 없으면 100% 발동, chance 있으면 확률 판정
function applyRankChanges(r, self, target) {
  if (!r) return []
  const msgs = []

  // chance가 있으면 확률 판정 (없으면 100%)
