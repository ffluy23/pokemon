...
// 선공 판정
// 반환값: “my” | “enemy” | “tie”
export function calcSpeed(mySpeed, enemySpeed) {
const myRoll  = mySpeed    + d10()
const eneRoll = enemySpeed + d10()

if (myRoll > eneRoll)  return “my”
if (eneRoll > myRoll)  return “enemy”
return “tie” // 동률이면 랜덤
}
