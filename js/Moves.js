export const moves = {
  ...
  "파도타기":   { power: 40, type: "물", priority: false, effect: null },
  "물대포":     { power: 40, type: "물", priority: false, effect: null },
  "하이드로펌프": { power: 40, type: "물", priority: false, effect: null },
  "아쿠아제트": { power: 40, type: "물", priority: true,  effect: null },
  ...
  "더블슬랩":   { power: 40, type: "노말", priority: false, effect: null },
  ...
  // 땅
  "지진":       { power: 40, type: "땅", priority: false, effect: null },
  "땅가르기":   { power: 40, type: "땅", priority: false, effect: null },

  // 바위
  "스톤에지":   { power: 40, type: "바위", priority: false, effect: null },
  "록블라스트": { power: 40, type: "바위", priority: false, effect: null },

  // 비행
  "에어슬래시": { power: 40, type: "비행", priority: false, effect: { chance: 0.3, volatile: "풀죽음" } },
  "열풍비행":   { power: 40, type: "비행", priority: false, effect: { chance: 0.1, status: "화상" } },

  // 에스퍼
  "사이코키네시스": { power: 40, type: "에스퍼", priority: false, effect: null },
  "미래예지":   { power: 40, type: "에스퍼", priority: false, effect: null },

  // 벌레
  "버그버즈":   { power: 40, type: "벌레", priority: false, effect: null },
  "시저크로스": { power: 40, type: "벌레", priority: false, effect: null },
  ...
  "역린":       { power: 40, type: "드래곤", priority: false, effect: { chance: 0.2, volatile: "혼란" } },
  ...
  "메탈크로":   { power: 40, type: "강철", priority: false, effect: null },
  "불릿펀치":   { power: 40, type: "강철", priority: true,  effect: null },

  // 페어리
  "문포스":     { power: 40, type: "페어리", priority: false, effect: null },
  "매지컬샤인": { power: 40, type: "페어리", priority: false, effect: null },

  // 날씨
  "맑게개다":   { power: 0, type: "불",   priority: false, effect: { chance: 1.0, weather: "쾌청" } },
  "비바라기":   { power: 0, type: "물",   priority: false, effect: { chance: 1.0, weather: "비" } },
  "모래바람":   { power: 0, type: "바위", priority: false, effect: { chance: 1.0, weather: "모래바람" } },
  "싸라기눈":   { power: 0, type: "얼음", priority: false, effect: { chance: 1.0, weather: "싸라기눈" } },
